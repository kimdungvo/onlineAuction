...
namespace eProject.Areas.Admin.Controllers
{
   ...
   [Area("Admin")]
    ...
    public class CategoryController : Controller
    {
        ...
        private Repository.IAuctionServices _services;
        public CategoryController(Repository.ICategoryServices services, Repository.IAuctionServices _services)
        {
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                var x = _services.GetAuctions().Where(x => x.Auction.CategoryId.Equals(id)).Count();
                if (x == 0)
                {
                ...
                {
                    ViewBag.msg = "You cannot delete this category, it contains" + x + " auctions";
                    return RedirectToAction("Index");
                }
